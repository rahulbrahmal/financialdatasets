...
Research and implementation specifications for cloning the Financial Datasets API structure and response format for Malaysia's Bursa market.

## RAHUL-39 Specs

- [Financial Datasets API inventory](docs/specs/rahul-39-financialdatasets-api-inventory.md)
